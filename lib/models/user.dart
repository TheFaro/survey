class User {
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
        ...
        phone: json['phone'].toString().isEmpty || json['phone'] == null
            ? ''
            : json['phone'].toString(),
        email: json['email'].toString().isEmpty || json['email'] == null
            ? ''
            : json['email'].toString(),
        gender: json['gender'].toString().isEmpty || json['gender'] == null
            ? ''
            : json['gender'].toString(),
        designation: json['designation'].toString().isEmpty ||
                json['designation'] == null
            ? ''
            : json['designation'].toString(),
        // organization: json['organization'].toString().isEmpty ||
        //         json['organization'] == null
        //     ? -1
        //     : int.parse(json['organization'].toString()),
        level: json['level'].toString().isEmpty || json['level'] == null
            ? -1
            : int.parse(json['level'].toString()),
        verificationCode: json['verification_code'].toString().isEmpty ||
                json['verification_code'] == null
            ? ''
            : json['verification_code'].toString(),
        status: json['status'].toString().isEmpty || json['status'] == null
            ? ''
